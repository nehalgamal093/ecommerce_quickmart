  ...
  Widget build(BuildContext context) {
    ...
    return Padding(
      ...
      child: Column(
        ...
        children: [
          SizedBox(height: 20,),
          Text('Old Password',style: Theme.of(context).textTheme.titleLarge,),
          SizedBox(height: 5,),
          Text('Enter old password to change the password',style: Theme.of(context).textTheme.bodySmall,),
          SizedBox(height: 20,),
