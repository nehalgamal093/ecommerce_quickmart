...
abstract class ProfileRepo{
  ...
  Future<Either<AppFailures,ChangePasswordResponse>> changePassword(String newPassword);
  Future<Either<AppFailures,AddressesModel>> addAddress({AddressRequest? request});
}